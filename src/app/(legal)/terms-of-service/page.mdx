...
Welcome to **Timero**, your ultimate time management tool featuring timer, stopwatch, alarm, and world clock. By accessing or using our service, you agree to be bound by these Terms of Service. If you do not agree with any of these terms, please do not use our service.

## Use of the Service

Timero provides users with a comprehensive time management platform including timer, stopwatch, alarm clock, and world time zone features. You agree to use the service in accordance with all applicable local, state, national, and international laws and regulations.
...
All content provided through Timero, including but not limited to software, design, and documentation, is protected under copyright law. The copyright owner of Timero is **Timero Team**.

- You acknowledge that you do not own the underlying technology or intellectual property that makes up the Timero service, and you agree to respect the intellectual property rights of Timero and any third parties.
- While you may use Timero for personal or commercial time management, the core Timero platform remains the property of Timero Team.

## Prohibited Activities

You agree not to engage in any of the following prohibited activities while using Timero:

- Unauthorized access to or reverse engineering of our software
...
Timero collects the following types of data:
...
To the fullest extent permitted by law, Timero shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from the use of or inability to use the service.

## Indemnification

You agree to indemnify and hold harmless Timero, its affiliates, and their respective officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including attorneys' fees) arising from your use of the service or violation of these Terms.

## Governing Law and Dispute Resolution

These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which Timero operates, without regard to its conflict of law provisions. Any disputes arising from these Terms or the service will be resolved through binding arbitration in accordance with applicable laws.
...
If you have any questions about these Terms, please contact us at support@timero.app.

---

By using Timero, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. Thank you for choosing Timero!
